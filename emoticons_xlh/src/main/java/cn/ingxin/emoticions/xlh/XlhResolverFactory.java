...
public class XlhResolverFactory implements ResolverFactory {
    ...
    public static XlhResolverFactory create() {
        return new XlhResolverFactory();
    }

    private XlhResolverFactory() {
    }
    ...
    private Drawable getDrawableFromResource(Context context, String emoticonKey) {
        Integer resId = XlhEmoticonUtils.emoticonMap.get(emoticonKey);
